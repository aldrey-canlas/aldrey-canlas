...
const PROJECT_DATA = {
  aiassistant: {
    ...
    tags: ['Next.js', 'OpenAI', 'LangChain', 'Pinecone', 'RAG'],
    description: 'A full stack Retrieval-Augmented Generation (RAG) application that lets users upload PDF and Word documents and chat with their content. The system chunks documents, generates OpenAI embeddings, and stores them in Pinecone for sub-second semantic retrieval. The Next.js frontend streams responses in real time using the OpenAI streaming API, giving users a fluid chat experience across corpora of 10,000+ pages.',
    highlights: [
      'Sub-second semantic retrieval across 10,000+ page document corpora via Pinecone',
      'Streamed OpenAI responses for a fluid, real-time chat experience',
      'Supports PDF, DOCX, and plain text uploads with automatic chunking and embedding',
      'Source citation — each answer includes the exact document passage it was drawn from',
      'Multi-document mode: query across multiple uploaded files simultaneously',
    ],
    github: null,
    live: null,
  },
  ecommerce: {
    ...
    tags: ['React', 'Node.js', 'PostgreSQL', 'Stripe', 'AI Recommendations'],
    description: 'An end-to-end e-commerce platform built with a React storefront, Node.js/Express REST API, PostgreSQL database, and Stripe payment integration. The platform includes an AI-powered product recommendation engine using collaborative filtering and OpenAI embeddings to surface personalized suggestions, which increased average order value by 22% in production.',
    highlights: [
      'AI recommendation engine boosted average order value by 22% in production',
      'Full Stripe integration: checkout, webhooks, refunds, and subscription billing',
      'React storefront with server-side rendering via Next.js for SEO and performance',
      'Role-based admin dashboard for inventory, orders, and analytics management',
      'PostgreSQL with Prisma ORM; Redis caching for product catalog and sessions',
    ],
    github: null,
    live: null,
  },
  codereviewer: {
    ...
    tags: ['TypeScript', 'GPT-4', 'FastAPI', 'GitHub API', 'Webhooks'],
    description: 'An automated code review tool that integrates with GitHub via webhooks. When a pull request is opened or updated, the bot fetches the diff, sends it to GPT-4 with a structured prompt, and posts inline review comments covering security vulnerabilities, performance issues, code style, and best practices. Reduced average review turnaround time by 60% in a team pilot.',
    highlights: [
      'Reduced average PR review turnaround by 60% in a 10-person engineering team pilot',
      'Inline GitHub comments with file, line, and severity context for each finding',
      'Configurable rule sets: security, performance, style, and custom team guidelines',
      'FastAPI backend with async processing; handles large diffs via chunked analysis',
      'Supports Python, TypeScript, JavaScript, and Go repositories',
    ],
    github: null,
    live: null,
  },
  dashboard: {
    ...
    tags: ['React', 'D3.js', 'Python', 'WebSockets', 'OpenAI'],
    description: 'An interactive analytics dashboard with live data streaming via WebSockets, rich D3.js visualizations (line charts, heatmaps, funnel charts), and a Python/FastAPI backend. Every 5 minutes, an OpenAI-powered summarizer generates a natural language digest of the most significant trends and anomalies, surfaced as a highlighted insight card at the top of the dashboard.',
    highlights: [
      'Real-time data streaming via WebSockets with sub-100ms update latency',
      'AI-generated natural language trend summaries refreshed every 5 minutes',
      'D3.js visualizations: time-series, heatmaps, funnels, and cohort retention charts',
      'Configurable alert thresholds with email and Slack notifications via webhooks',
      'Multi-tenant architecture: each client sees only their own data with row-level security',
    ],
    github: null,
    live: null,
  },
  contentgen: {
    ...
    tags: ['Next.js', 'OpenAI', 'Supabase', 'Tailwind CSS', 'Stripe'],
    description: 'A SaaS platform for generating SEO-optimized blog posts, product descriptions, and social media copy. Built with Next.js and the OpenAI API, with a Supabase backend for user authentication, content history, and team collaboration. Subscription billing is handled via Stripe. The platform has grown to 500+ active users since launch.',
    highlights: [
      '500+ active users with monthly and annual subscription tiers via Stripe',
      'SEO-optimized output: keyword density analysis and meta description generation',
      'Team workspaces: share brand voice settings and content templates across members',
      'Content history with version diffing — compare and restore previous generations',
      'Tone and style controls: formal, casual, persuasive, technical, and custom presets',
    ],
    github: null,
    live: null,
  },
  apigw: {
    title: 'AI API Gateway & Rate Limiter',
    tags: ['FastAPI', 'Redis', 'Docker', 'JWT', 'React'],
    description: 'A production-grade API gateway for proxying LLM requests with per-user rate limiting, token cost tracking, and intelligent caching of repeated queries in Redis. The React admin dashboard provides real-time usage analytics, cost breakdowns by user and model, and configurable rate limit policies. Designed to sit in front of any OpenAI-compatible API.',
    highlights: [
      'Per-user rate limiting with configurable token and request quotas via Redis',
      'Semantic caching: identical or near-identical queries return cached responses instantly',
      'Real-time cost tracking per user, team, and model with monthly budget alerts',
      'JWT-based authentication with API key management and rotation',
      'React admin dashboard with live usage charts and per-endpoint latency metrics',
    ],
    github: null,
    live: null,
  },
  chatapp: {
    title: 'Real-Time Chat with AI Copilot',
    tags: ['React', 'Socket.io', 'Node.js', 'MongoDB', 'OpenAI'],
    description: 'A full stack real-time chat application with persistent message history in MongoDB and an embedded AI copilot powered by OpenAI function calling. The copilot can answer questions from a connected knowledge base, summarize long threads on demand, draft replies in the user\'s tone, and perform actions like creating tasks or scheduling meetings via tool integrations.',
    highlights: [
      'Real-time messaging via Socket.io with typing indicators and read receipts',
      'AI copilot with function calling: summarize threads, draft replies, create tasks',
      'Persistent message history in MongoDB with full-text search',
      'End-to-end encryption for direct messages using the Web Crypto API',
      'File sharing with image previews and PDF viewer embedded in the chat window',
    ],
    github: null,
    live: null,
  },
  resumeparser: {
    ...
    tags: ['Python', 'LlamaIndex', 'React', 'PostgreSQL', 'Embeddings'],
    description: 'An automated resume parsing and job-matching tool that uses LlamaIndex for structured information extraction and OpenAI embeddings for semantic similarity scoring. The system processes uploaded PDFs, extracts structured data (skills, experience, education), and ranks candidates against job descriptions using cosine similarity over embedding vectors stored in PostgreSQL with pgvector.',
    highlights: [
      'Structured extraction of skills, experience, education, and contact info from PDFs',
      'Semantic similarity ranking of candidates against job descriptions via pgvector',
      'Batch processing: parse and rank 100+ resumes against a job posting in under 30 seconds',
      'Explainable match scores: highlights the specific skills and experience driving each rank',
      'React dashboard for recruiters with filtering, sorting, and candidate comparison views',
    ],
    github: null,
    live: null,
  },
  devtools: {
    title: 'AI Developer Toolkit Extension',
    tags: ['TypeScript', 'Vite', 'OpenAI', 'Chrome Extension', 'DevTools'],
    description: 'A Chrome extension that adds an AI-powered panel to the browser DevTools. Developers can highlight any code snippet for instant explanation, generate regex patterns from natural language descriptions, format and validate JSON, inspect and annotate API responses, and ask questions about the current page\'s JavaScript context — all without leaving the browser.',
    highlights: [
      'Code explanation: highlight any snippet in DevTools for an instant AI breakdown',
      'Regex generator: describe a pattern in plain English and get a tested regex',
      'JSON formatter with schema inference and validation against user-defined schemas',
      'API response inspector: annotates fetch/XHR responses with field descriptions',
      'Context-aware Q&A: ask questions about the current page\'s JS variables and state',
    ],
    github: null,
    live: null,
  },
